...
/**
 * Firsly, Call static function genSecretKey to create CRYPTO_SECRET_KEY
 * Then embled CRYPTO_SECRET_KEY={value} into .env file
 * Start project and using Cryptography
 */
export class Cryptography {
	private _algorithm = 'aes-256-cbc';
	private _secretKey = Buffer.from(process.env.CRYPTO_SECRET_KEY, 'base64');
	 ...
	 * @returns {string}
	 */
	static cyrb53(str: string, seed = 0) {
	 ...
	 */
	static hashFnv32a(str: string, seed = 0x811c9dc5, asString = true) {
